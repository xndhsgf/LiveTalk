...
export const APP_ASSETS = {
  // يمكنك تغيير الروابط هنا لتغيير خلفيات الموقع بالكامل
  mainBackground: 'https://images.unsplash.com/photo-1614850523296-d8c1af93d400?q=80&w=2070&auto=format&fit=crop',
  loginBackground: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=2070&auto=format&fit=crop',
  defaultAvatar: 'https://picsum.photos/seed/user/200'
};
