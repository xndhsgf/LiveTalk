                    ...
                    <>
                      <div className="p-3 bg-red-600/5 rounded-2xl border border-red-600/20 space-y-3">
                        ...
                        <div className="flex gap-2">
                           <button onClick={() => setEditingFields({...editingFields, banDevice: !editingFields.banDevice})} className={`flex-1 py-2 rounded-lg border flex items-center justify-center gap-1 text-[8px] font-black transition-all ${editingFields.banDevice ? 'bg-red-600/20 border-red-500 text-white' : 'bg-black/40 border-white/5 text-slate-500'}`}>
