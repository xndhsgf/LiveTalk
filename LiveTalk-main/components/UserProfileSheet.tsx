             ...
             <div className="bg-[#0f172a] border border-white/10 rounded-[2.5rem] w-full max-w-sm p-6 shadow-2xl space-y-3 overflow-hidden relative">
                <div className="flex justify-between items-center mb-4 border-b border-white/5 pb-4">
                   <div className="flex items-center gap-2">
                      ...
                      <h4 className="text-white font-black">إدارة العضو في الغرفة</h4>
                   </div>
                ...
                {isHost && (
                   ...
                   >
                      <div className="flex items-center gap-3">
                         <ShieldCheck size={18} />
                         <span>{isTargetModerator ? 'سحب الإشراف الدائم' : 'تعيين كـمشرف دائم'}</span>
                      </div>
                ...
                {canManage && (
                   ...
                   >
                      <MicOff size={18} /> تنزيل من المايك
                   </button>
                )}
